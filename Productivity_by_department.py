...
def cargar_roster():
    return pd.read_csv(
        'https://docs.google.com/spreadsheets/d/e/2PACX-1vS0HaWItYoSrWOqFq8Mmm0NnSDo7zok8lzqbBpmjuyeRpNVLwZZ8wEumtoNh-t3ucHEQ0I_qCrXAF39/pub?gid=220893030&single=true&output=csv'
    )
